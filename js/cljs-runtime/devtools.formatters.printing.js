...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12721){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12722,G__12723,seq12721__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12746_SHARP_){
return (!((cljs.core.meta(p1__12746_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12771__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12772){var _e__11594__auto__ = e12772;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12774){var _e__11594__auto__ = e12774;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12778 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12779 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12779);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12781__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12778);
}});
...
var _STAR_print_level_STAR__orig_val__12785_12816 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12786_12817 = managed_print_level_12815;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12786_12817);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12782_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12782_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12785_12816);
}} else {
job_fn();
}
