...
var G__22693 = o;
reagent.impl.template.goog$module$goog$object.set(G__22693,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22793__delegate = function (args){
...
while (G__22794__i < G__22794__a.length) {G__22794__a[G__22794__i] = arguments[G__22794__i + 0]; ++G__22794__i;}
  args = new cljs.core.IndexedSeq(G__22794__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22795);
...
var G__22703 = o;
reagent.impl.template.goog$module$goog$object.set(G__22703,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22799__i < G__22799__a.length) {G__22799__a[G__22799__i] = arguments[G__22799__i + 0]; ++G__22799__i;}
  args = new cljs.core.IndexedSeq(G__22799__a,0,null);
} 
...
var G__22706 = props;
var G__22706__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22706,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22706);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22706__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22714 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22714,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22714;
}
})(),id_class);
...
var G__22716 = (cljs.core.count(argv) - first_child);
switch (G__22716) {
case (0):
...
var vec__22720 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22720,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22720,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22720,(2),null);
...
var temp__5808__auto___22808 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22808 == null)){
} else {
var key_22809 = temp__5808__auto___22808;
(jsprops.key = key_22809);
}
...
var temp__5808__auto___22810 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22810 == null)){
} else {
var key_22811 = temp__5808__auto___22810;
(jsprops.key = key_22811);
}
...
var temp__5808__auto___22812 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22812 == null)){
} else {
var key_22813 = temp__5808__auto___22812;
(jsprops.key = key_22813);
}
...
var temp__5808__auto___22822 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
var temp__5808__auto___22824 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22824 == null)){
} else {
var key_22825 = temp__5808__auto___22824;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22754_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22754_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22763 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22763,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22763,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template22783 = (function (opts,id,fn_to_element,parse_fn,meta22784){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22783.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22785,meta22784__$1){
var self__ = this;
var _22785__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22783(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22784__$1));
}));

(reagent.impl.template.t_reagent$impl$template22783.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22785){
var self__ = this;
var _22785__$1 = this;
return self__.meta22784;
}));

(reagent.impl.template.t_reagent$impl$template22783.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22783.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22783.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22783.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22783.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22783.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22784","meta22784",-1230259613,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22783.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22783.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22783");

(reagent.impl.template.t_reagent$impl$template22783.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22783");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22783.
 */
reagent.impl.template.__GT_t_reagent$impl$template22783 = (function reagent$impl$template$__GT_t_reagent$impl$template22783(opts,id,fn_to_element,parse_fn,meta22784){
return (new reagent.impl.template.t_reagent$impl$template22783(opts,id,fn_to_element,parse_fn,meta22784));
});
...
return (new reagent.impl.template.t_reagent$impl$template22783(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
