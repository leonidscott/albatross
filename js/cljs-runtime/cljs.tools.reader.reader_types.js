...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24075 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24075(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24076 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24076(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24080 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24080(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24081 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24081(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24083 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24083(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24084 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24084(reader);
}
});
...
var G__24110 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__24111 = s.append(c);
c = G__24110;
s = G__24111;
continue;
}
