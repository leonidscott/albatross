...
var G__12711 = devtools.prefs.pref(v);
v = G__12711;
continue;
} else {
return v;
...
}catch (e12668){var _e__11594__auto__ = e12668;
return false;
}})();
...
}catch (e12674){var _e__11594__auto__ = e12674;
return false;
}})();
...
}catch (e12678){var _e__11594__auto__ = e12678;
return false;
}}
}
});
...
var vec__12692 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12692,(1),null);
...
return cljs.core.some((function (p1__12699_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12699_SHARP_);
}),template);
});
