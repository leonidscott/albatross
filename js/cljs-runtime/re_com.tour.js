...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26399_SHARP_,p2__26400_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__26399_SHARP_,p2__26400_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_com$tour$initialise_tour_$_iter__26407(s__26408){
return (new cljs.core.LazySeq(null,(function (){
var s__26408__$1 = s__26408;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26408__$1);
if(temp__5804__auto__){
var s__26408__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26408__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__26408__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__26410 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__26409 = (0);
while(true){
if((i__26409 < size__5522__auto__)){
var step = cljs.core._nth(c__5521__auto__,i__26409);
cljs.core.chunk_append(b__26410,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__26473 = (i__26409 + (1));
i__26409 = G__26473;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26410),re_com$tour$initialise_tour_$_iter__26407(cljs.core.chunk_rest(s__26408__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26410),null);
}
} else {
var step = cljs.core.first(s__26408__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__26407(cljs.core.rest(s__26408__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__26426 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__26426.cljs$core$IFn$_invoke$arity$1 ? fexpr__26426.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__26426.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__26435 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__26435.cljs$core$IFn$_invoke$arity$1 ? fexpr__26435.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__26435.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__26438 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__26438.cljs$core$IFn$_invoke$arity$1 ? fexpr__26438.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__26438.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__26447 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__26447.cljs$core$IFn$_invoke$arity$1 ? fexpr__26447.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__26447.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__26449 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__26449.cljs$core$IFn$_invoke$arity$1 ? fexpr__26449.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__26449.call(null,tour));
})(),true);
} else {
return null;
}
