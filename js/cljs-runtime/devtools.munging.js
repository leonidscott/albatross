...
var o12242 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12242["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12244 = temp__5802__auto____$1;
return (o12244["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11560__auto__ = f;
return (o__11560__auto__["toString"]).call(o__11560__auto__);
} else {
return "";
}
}catch (e12252){var _ = e12252;
return "";
}});
...
try{var o__11560__auto___12659 = t;
(o__11560__auto___12659["cljs$lang$ctorPrWriter"]).call(o__11560__auto___12659,t,writer);
}catch (e12278){var __12660 = e12278;
}
...
var char_code = (function (){var o__11560__auto__ = (new String(char$));
return (o__11560__auto__["charCodeAt"]).call(o__11560__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11560__auto__ = String;
return (o__11560__auto__["fromCharCode"]).call(o__11560__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12310 = num_code;
switch (G__12310) {
case (1):
return (185);
...
var o__11560__auto__ = String;
return (o__11560__auto__["fromCharCode"]).call(o__11560__auto__,superscript_code);
});
/**
...
}catch (e12353){var _e__11594__auto__ = e12353;
return false;
}})())){
...
var vec__12356 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12356,(0),null);
...
var len__5769__auto___12670 = arguments.length;
var i__5770__auto___12671 = (0);
while(true){
if((i__5770__auto___12671 < len__5769__auto___12670)){
args__5775__auto__.push((arguments[i__5770__auto___12671]));

var G__12672 = (i__5770__auto___12671 + (1));
i__5770__auto___12671 = G__12672;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12389){
var vec__12390 = p__12389;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12390,(0),null);
...
var G__12676 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12677 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12676;
remaining_tokens = G__12677;
continue;
}
}
break;
...
var vec__12406 = cljs.core.split_with((function (p1__12404_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12404_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12406,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12406,(1),null);
...
var vec__12420 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12420,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12420,(1),null);
...
var vec__12433 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12433,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12433,(1),null);
var vec__12436 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12436,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12436,(1),null);
var vec__12439 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(3),null);
...
var vec__12459 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12465 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12465,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12465,(1),null);
var vec__12470 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12470,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12470,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12510 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12510) : devtools.munging.parse_fn_info_deep.call(null,G__12510));
})()));
}
} else {
return fn_info;
...
var G__12700 = (arity + (1));
var G__12701 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12548){
var vec__12550 = p__12548;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12550,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12550,(1),null);
...
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12561_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12561_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12571){
var vec__12572 = p__12571;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12572,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12564){
var G__12565 = cljs.core.first(seq12564);
var seq12564__$1 = cljs.core.next(seq12564);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12565,seq12564__$1);
}));
...
var map__12603 = options;
var map__12603__$1 = cljs.core.__destructure_map(map__12603);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12603__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12603__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12603__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12603__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12604 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(5),null);
...
var o__11560__auto__ = f;
return (o__11560__auto__["getBasis"]).call(o__11560__auto__);
});
/**
...
}catch (e12617){var _e__11594__auto__ = e12617;
...
var G__12713 = (obj[cljs.core.first(path)]);
var G__12714 = cljs.core.rest(path);
obj = G__12713;
path = G__12714;
continue;
} else {
...
var _STAR_ = (function (accum,p__12627){
var vec__12629 = p__12627;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12629,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12629,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12634){
var vec__12635 = p__12634;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12635,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12635,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12635,(2),null);
...
var post_process = (function (p__12648){
var vec__12650 = p__12648;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12650,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12650,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12642_SHARP_){
return (obj[cljs.core.first(p1__12642_SHARP_)]);
}),sorted_matches);
