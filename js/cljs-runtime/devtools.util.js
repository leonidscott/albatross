...
var len__5769__auto___14299 = arguments.length;
var i__5770__auto___14300 = (0);
while(true){
if((i__5770__auto___14300 < len__5769__auto___14299)){
args__5775__auto__.push((arguments[i__5770__auto___14300]));

var G__14301 = (i__5770__auto___14300 + (1));
i__5770__auto___14300 = G__14301;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__14188_14302 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__14189_14303 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__14190_14304 = true;
var _STAR_print_fn_STAR__temp_val__14191_14305 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__14190_14304);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__14191_14305);

try{var _STAR_print_level_STAR__orig_val__14193_14306 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14194_14307 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14194_14307);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14193_14306);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__14189_14303);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__14188_14302);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq14184){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14184));
}));
...
var new_formatters = current_formatters.filter((function (p1__14223_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__14223_SHARP_)));
}));
...
var G__14237_14317 = f;
var target__11586__auto___14318 = G__14237_14317;
if(cljs.core.truth_(target__11586__auto___14318)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14237_14317)].join(''),"\n","target__11586__auto__"].join('')));
}

(target__11586__auto___14318["toString"] = (function (){
...
var G__14241_14319 = "%c%s";
var G__14242_14320 = "color:transparent";
var G__14243_14321 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__14241_14319,G__14242_14320,G__14243_14321) : f.call(null,G__14241_14319,G__14242_14320,G__14243_14321));
...
var G__14336 = (i__5770__auto___14330 + (1));
i__5770__auto___14330 = G__14336;
continue;
} else {
}
break;
...
var vec__14252 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14252,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14252,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__14347__delegate = function (add_fmt,add_args){
...
var G__14347 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__14348__i = 0, G__14348__a = new Array(arguments.length -  1);
while (G__14348__i < G__14348__a.length) {G__14348__a[G__14348__i] = arguments[G__14348__i + 1]; ++G__14348__i;}
  add_args = new cljs.core.IndexedSeq(G__14348__a,0,null);
} 
return G__14347__delegate.call(this,add_fmt,add_args);};
G__14347.cljs$lang$maxFixedArity = 1;
G__14347.cljs$lang$applyTo = (function (arglist__14349){
var add_fmt = cljs.core.first(arglist__14349);
var add_args = cljs.core.rest(arglist__14349);
return G__14347__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq14244){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14245,G__14246,G__14247,seq14244__$3);
}));
...
var seq__14268 = cljs.core.seq(features);
var chunk__14269 = null;
var count__14270 = (0);
var i__14271 = (0);
while(true){
if((i__14271 < count__14270)){
var feature = chunk__14269.cljs$core$IIndexed$_nth$arity$2(null,i__14271);
...
var G__14352 = seq__14268;
var G__14353 = chunk__14269;
var G__14354 = count__14270;
var G__14355 = (i__14271 + (1));
seq__14268 = G__14352;
chunk__14269 = G__14353;
count__14270 = G__14354;
i__14271 = G__14355;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__14268);
if(temp__5804__auto__){
var seq__14268__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__14268__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__14268__$1);
var G__14356 = cljs.core.chunk_rest(seq__14268__$1);
var G__14357 = c__5568__auto__;
var G__14358 = cljs.core.count(c__5568__auto__);
var G__14359 = (0);
seq__14268 = G__14356;
chunk__14269 = G__14357;
count__14270 = G__14358;
i__14271 = G__14359;
continue;
} else {
var feature = cljs.core.first(seq__14268__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__14364 = cljs.core.next(seq__14268__$1);
var G__14365 = null;
var G__14366 = (0);
var G__14367 = (0);
seq__14268 = G__14364;
chunk__14269 = G__14365;
count__14270 = G__14366;
i__14271 = G__14367;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14295 = temp__5802__auto__;
return (o14295["version"]);
} else {
return null;
}
})() == null);
