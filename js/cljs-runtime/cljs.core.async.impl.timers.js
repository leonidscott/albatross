...
var i_17225 = (self__.level + (1));
while(true){
if((i_17225 <= (new_level + (1)))){
(update[i_17225] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_17227 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17227[i]));
} else {
x__$2.forward.push((((i < links_17227.length))?(links_17227[i]):null));
}

if((i < links_17227.length)){
(links_17227[i] = x__$2);
} else {
links_17227.push(x__$2);
}
...
var i_17229 = (0);
while(true){
if((i_17229 <= self__.level)){
var links_17230 = (update[i_17229]).forward;
if((x__$1 === (((i_17229 < links_17230.length))?(links_17230[i_17229]):null))){
(links_17230[i_17229] = (x__$1.forward[i_17229]));

var G__17231 = (i_17229 + (1));
i_17229 = G__17231;
continue;
} else {
var G__17232 = (i_17229 + (1));
i_17229 = G__17232;
continue;
}
} else {
