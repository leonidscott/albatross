...
while(true){
if((i__5770__auto___12587 < len__5769__auto___12585)){
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq12455){
...
return cljs.core.some((function (p1__12481_SHARP_){
return (p1__12481_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__12518){
var vec__12520 = p__12518;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12520,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq12511){
...
var G__12601 = (i__5770__auto___12596 + (1));
i__5770__auto___12596 = G__12601;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__12536){
var vec__12537 = p__12536;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12537,(0),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq12531){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12532,G__12533,seq12531__$2);
}));
