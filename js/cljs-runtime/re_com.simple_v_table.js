...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__26701,new_key_fn,new_comp){
var map__26702 = p__26701;
var map__26702__$1 = cljs.core.__destructure_map(map__26702);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26702__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26702__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__26703,parts,sort_by_column){
var map__26704 = p__26703;
var map__26704__$1 = cljs.core.__destructure_map(map__26704);
var column = map__26704__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26704__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26704__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
...
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26704__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26704__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26704__$1,new cljs.core.Keyword(null,"header-label","header-label",765876429));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26704__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var map__26705 = sort_by;
var map__26705__$1 = cljs.core.__destructure_map(map__26705);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26705__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479),row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26705__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var map__26706 = cljs.core.deref(sort_by_column);
var map__26706__$1 = cljs.core.__destructure_map(map__26706);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26706__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26706__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-column-header","simple-column-header",-1241463404),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__5523__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__26707(s__26708){
return (new cljs.core.LazySeq(null,(function (){
var s__26708__$1 = s__26708;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26708__$1);
if(temp__5804__auto__){
var s__26708__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26708__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__26708__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__26710 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__26709 = (0);
while(true){
if((i__26709 < size__5522__auto__)){
var column = cljs.core._nth(c__5521__auto__,i__26709);
cljs.core.chunk_append(b__26710,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__26745 = (i__26709 + (1));
i__26709 = G__26745;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26710),re_com$simple_v_table$column_header_renderer_$_iter__26707(cljs.core.chunk_rest(s__26708__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26710),null);
}
} else {
var column = cljs.core.first(s__26708__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__26707(cljs.core.rest(s__26708__$2)));
}
} else {
return null;
}
 ...
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__26711,cell_style,parts){
var map__26712 = p__26711;
var map__26712__$1 = cljs.core.__destructure_map(map__26712);
var column = map__26712__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26712__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26712__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26712__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26712__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26712__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-row","simple-row",-252554766),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__5523__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__26713(s__26714){
return (new cljs.core.LazySeq(null,(function (){
var s__26714__$1 = s__26714;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26714__$1);
if(temp__5804__auto__){
var s__26714__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26714__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__26714__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__26716 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__26715 = (0);
while(true){
if((i__26715 < size__5522__auto__)){
var column = cljs.core._nth(c__5521__auto__,i__26715);
cljs.core.chunk_append(b__26716,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__26753 = (i__26715 + (1));
i__26715 = G__26753;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26716),re_com$simple_v_table$row_renderer_$_iter__26713(cljs.core.chunk_rest(s__26714__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26716),null);
}
} else {
var column = cljs.core.first(s__26714__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__26713(cljs.core.rest(s__26714__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26717_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__26717_SHARP_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.inc);
...
var len__5769__auto___26754 = arguments.length;
var i__5770__auto___26755 = (0);
while(true){
if((i__5770__auto___26755 < len__5769__auto___26754)){
args__5775__auto__.push((arguments[i__5770__auto___26755]));

var G__26756 = (i__5770__auto___26755 + (1));
i__5770__auto___26755 = G__26756;
continue;
} else {
}
break;
...
(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__26724){
var map__26725 = p__26724;
var map__26725__$1 = cljs.core.__destructure_map(map__26725);
var args = map__26725__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26725__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
...
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__26726){
var map__26727 = p__26726;
var map__26727__$1 = cljs.core.__destructure_map(map__26727);
var args__$1 = map__26727__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"cell-style","cell-style",1087536089));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"on-leave-row","on-leave-row",1361264390));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"on-enter-row","on-enter-row",-139996948));
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26727__$1,new cljs.core.Keyword(null,"row-height","row-height",527360749),(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"max-width","max-width",-1939924051));
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"on-click-row","on-click-row",-383826673));
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26727__$1,new cljs.core.Keyword(null,"table-row-line-color","table-row-line-color",680569135),"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26727__$1,new cljs.core.Keyword(null,"table-padding","table-padding",-702873839),(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26727__$1,new cljs.core.Keyword(null,"column-header-height","column-header-height",-1680092558),(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"row-style","row-style",1352472052));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26727__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26727__$1,new cljs.core.Keyword(null,"fixed-column-border-color","fixed-column-border-color",2036669142),"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26727__$1,new cljs.core.Keyword(null,"column-header-renderer","column-header-renderer",-1886265578),re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26727__$1,new cljs.core.Keyword(null,"fixed-column-count","fixed-column-count",721535030),(0));
...
var map__26728 = temp__5802__auto__;
var map__26728__$1 = cljs.core.__destructure_map(map__26728);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26728__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26728__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26728__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
while (G__26759__i < G__26759__a.length) {G__26759__a[G__26759__i] = arguments[G__26759__i + 0]; ++G__26759__i;}
  p__26726 = new cljs.core.IndexedSeq(G__26759__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__26726);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__26760){
var p__26726 = cljs.core.seq(arglist__26760);
return re_com$simple_v_table$simple_v_table_render__delegate(p__26726);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq26723){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq26723));
}));
